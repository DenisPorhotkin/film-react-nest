...
import { IsUUID, IsDateString, IsNumber, IsPositive, Min, IsOptional, IsEmail, IsPhoneNumber, IsArray, ValidateNested, ArrayMinSize } from 'class-validator';
...
export class OrderListResponseDto {
  @ApiProperty({ description: 'Общее количество созданных заказов', example: 2 })
  total: number;

  @ApiProperty({ description: 'Список созданных заказов', type: [OrderResponseDto] })
